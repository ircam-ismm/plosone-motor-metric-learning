...
import os
from pathlib import Path
@cli.command(short_help='Fix artifact location path for local all mlruns.')
@click.argument('path', type=str, default=os.getcwd())
def fix_artifact_paths(path: str) -> None:
    """Changes the absolute paths in MLflow mlruns database to point start with path.
    Taken from mlf-core:
    https://github.com/mlf-core/mlf-core/blob/c997a20419b075b2860119b3a4cd06dc132ec704/mlf_core/cli.py#L299
    """
